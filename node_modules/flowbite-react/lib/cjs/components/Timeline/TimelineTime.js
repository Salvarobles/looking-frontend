...
const TimelineTime = ({ children, className, theme: customTheme = {}, ...props }) => {
    ...
    const theme = (0, merge_deep_1.mergeDeep)(contentTheme.time, customTheme);
    return ((0, jsx_runtime_1.jsx)("time", { className: (0, tailwind_merge_1.twMerge)(theme.base, className), ...props, children: children }));
};

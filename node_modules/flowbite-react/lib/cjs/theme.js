...
const theme_25 = require("./components/Popover/theme");
const theme_26 = require("./components/Progress/theme");
const theme_27 = require("./components/Radio/theme");
const theme_28 = require("./components/RangeSlider/theme");
const theme_29 = require("./components/Rating/theme");
const theme_30 = require("./components/Select/theme");
const theme_31 = require("./components/Sidebar/theme");
const theme_32 = require("./components/Spinner/theme");
const theme_33 = require("./components/Table/theme");
const theme_34 = require("./components/Tabs/theme");
const theme_35 = require("./components/Textarea/theme");
const theme_36 = require("./components/TextInput/theme");
const theme_37 = require("./components/Timeline/theme");
const theme_38 = require("./components/Toast/theme");
const theme_39 = require("./components/ToggleSwitch/theme");
const theme_40 = require("./components/Tooltip/theme");
exports.theme = {
    ...
    popover: theme_25.popoverTheme,
    progress: theme_26.progressTheme,
    radio: theme_27.radioTheme,
    rangeSlider: theme_28.rangeSliderTheme,
    rating: theme_29.ratingTheme,
    ratingAdvanced: theme_29.ratingAdvancedTheme,
    select: theme_30.selectTheme,
    textInput: theme_36.textInputTheme,
    textarea: theme_35.textareaTheme,
    toggleSwitch: theme_39.toggleSwitchTheme,
    sidebar: theme_31.sidebarTheme,
    spinner: theme_32.spinnerTheme,
    table: theme_33.tableTheme,
    tabs: theme_34.tabTheme,
    timeline: theme_37.timelineTheme,
    toast: theme_38.toastTheme,
    tooltip: theme_40.tooltipTheme,
};
